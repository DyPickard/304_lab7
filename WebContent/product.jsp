...
try ( Connection con = DriverManager.getConnection(url, uid, pw)){
    ...
    // Display data
    out.println("<h2>" + r.getString("productName") + "</h2><table border=2><tr><th>Id</th><td>" + prodId + "</td></tr><tr><th>Price</th><td>" + r.getFloat("productPrice") + "</td></tr><tr><th>Description</th><td>" + r.getString("productDesc") + "</td>");
